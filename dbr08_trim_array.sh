...
python ./ParseDBR_ddRAD/ParseFastQ.py -r x${SLURM_ARRAY_TASK_ID}_R1.fastq  \
         ...
         -i ACTTGA -e AATT -n ./batch2/batch2_DBR08_x${SLURM_ARRAY_TASK_ID}_R1_output.fastq \
         -N ./batch2/batch2_DBR08_x${SLURM_ARRAY_TASK_ID}_R2_output.fastq \
         --drop ./batch2/batch2_dropped_DBR08_${SLURM_ARRAY_TASK_ID}.txt -Z -l 1
